    ...
    <main className='privacy flex flex-col items-center bg-brand-primary-light dark:bg-gray-950'>
      <div className='fade-in mx-2 my-8 max-w-[55rem] bg-white p-6 shadow-panel sm:mx-5 sm:rounded-lg sm:p-8'>
        ...
        <p>
          ...
          users (each, a “User”) of the Solar Moon Analytics.io website
          ...
          our customers. We collect information from Users in a variety of ways,
          including, but not limited to, when Users visit our site, register on
          the site, place an order, and in connection with other activities,
          services, features or resources we make available on our Site. We
          collect information you provide to us on our Site such as your name,
          email address and demographics. Users can always refuse to supply
          personally identification information, except that it may prevent them
          from engaging in certain Site related activities. <br />
          <br />
          When you visit our Site, some information is automatically collected.
          This may include information such as the Operating System (OS) running
          on your device, Internet Protocol (IP) address, access times, browser
          type, and language, and the website you visited before our Site. We
          also collect information about how you use Solar Moon Analytics LLCs’
          product(s). <br />
          <br />
          We automatically collect information using “cookies” and Web beacons.
          Cookies are small data files stored on your hard drive by a website
          and web beacons are electronic images that may be used on our Site or
          in our emails. Among other things, cookies help us improve our Site,
          our marketing activities, and your experience. We use cookies to see
          which areas and features are popular and to count visits to our Site.{' '}
          <br />
          <br />
          Most Web browsers are set to accept cookies by default. If you prefer,
          you can choose to set your browser to remove cookies and to reject
          cookies. If you set your browser to reject cookies, some features will
          be unavailable. For more information on how to reject cookies, see
          ...
          <br />
          <br /> - To process transactions We may use the information Users
          ...
          processing, will only be used to send them information and updates
          ...
          opt-in to our mailing list, they will receive emails that may include
          company news, updates, related product or service information, etc. If
          at any time the User would like to unsubscribe from receiving future
          ...
          email, password, transaction information and data stored on our Site.
          ...
          data from individuals under the age of 14. If you are not 14 or older,
