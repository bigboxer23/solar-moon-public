...
describe('Home Component', () => {
  ...
  it('renders the platform description', () => {
    ...
    expect(
      screen.getByText(/Our platform empowers businesses/i),
    ).toBeInTheDocument();
    expect(
      screen.getByText(/seamlessly oversee their solar energy infrastructure/i),
    ).toBeInTheDocument();
  });
