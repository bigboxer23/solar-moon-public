...
describe('Features Component', () => {
  ...
  it('renders feature descriptions', () => {
    ...
    expect(
      screen.getByText(/multitude of devices seamlessly/i),
    ).toBeInTheDocument();
    expect(
      screen.getByText(/tailored to meet your specific needs/i),
    ).toBeInTheDocument();
    expect(
      screen.getByText(/live data from all your devices/i),
    ).toBeInTheDocument();
  ...
  it('renders feature cards in correct container', () => {
    ...
    const cardsContainer = container.querySelector(
      '.my-8.flex.flex-wrap.justify-around',
    );
