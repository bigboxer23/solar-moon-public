...
describe('About Component', () => {
  ...
  it('displays company description', () => {
    ...
    expect(screen.getByText(/Minneapolis-based software development firm/i)).toBeInTheDocument();
  ...
  it('renders section headings with brand-primary styling', () => {
    ...
    expect(locationHeading).toHaveClass('text-lg', 'font-bold', 'text-brand-primary');
  });
  ...
  it('displays Minneapolis location information', () => {
    ...
    expect(screen.getByText(/Based in Minneapolis, Minnesota/i)).toBeInTheDocument();
  });
});